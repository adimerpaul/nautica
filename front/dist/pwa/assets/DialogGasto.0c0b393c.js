...
</html>`,document.getElementById("myElement").innerHTML=r,new T().print(document.getElementById("myElement")),i(a)}).catch(a=>{s(a)})})}static reportTotal(t,i){const s=t.filter(e=>e.tipoVenta==="Ingreso").reduce((e,u)=>e+u.montoTotal,0),o=t.filter(e=>e.tipoVenta==="Egreso").reduce((e,u)=>e+u.montoTotal,0),n=s-o;return console.log("montoTotal",n),new Promise((e,u)=>{const c=F.conversorNumerosALetras,a=new c,r=Math.abs(n),v=a.convertToText(parseInt(r)),p={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},f=x().env;C.toDataURL(` Monto: ${parseFloat(n).toFixed(2)}`,p).then(E=>{let $=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
...
<hr><hr><div class='titulo'>DETALLE</div>`;t.forEach(b=>{$+=`<div style='font-size: 12px'><b> ${b.user.name} </b></div>`,$+=`<div> ${parseFloat(b.montoTotal).toFixed(2)} ${b.tipoVenta}
    ...
    </html>`,document.getElementById("myElement").innerHTML=r,new T().print(document.getElementById("myElement")),i(a)}).catch(a=>{s(a)})})}static reciboTranferencia(t,i,s,o){return console.log("producto",t,"de",i,"ha",s,"cantidad",o),new Promise((n,e)=>{const u=F.conversorNumerosALetras,a=new u().convertToText(parseInt(o)),r={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},v=x().env;C.toDataURL(`de: ${i} A: ${s}`,r).then(p=>{let f=`${this.head()}
    <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
    <img src="/logo.png" alt="logo" style="width: 100px; height: 100px; display: block; margin-left: auto; margin-right: auto;">
